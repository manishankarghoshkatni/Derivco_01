...
Start the web api application:
	...
	4.	Locate the connection string with the name as ‘InventoryEntities’ and find the ‘data source’ option in it. 
		Replace it with a proper value. It takes the format as ‘Database host\sql server instance name’ like 
			mydbhost\sqlexpress 
	5.	Save it.
	6.	Run the project. It will open a browser window and display ‘Product Service running …’ once started.
