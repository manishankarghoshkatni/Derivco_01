...
<table class="table-condensed">
    <tr>
        ...
        <td><asp:TextBox ID="TxtId" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="TxtId" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">Category Id is required</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>Name</td>
        <td><asp:TextBox ID="TxtCategoryName" runat="server" MaxLength="100"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="TxtCategoryName" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red">Category Name is required</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>Description</td>
        <td><asp:TextBox ID="TxtDescription" runat="server" MaxLength="300"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtDescription" ErrorMessage="RequiredFieldValidator" ForeColor="Red">Category Description is required</asp:RequiredFieldValidator>
        </td>
    </tr>
</table>
