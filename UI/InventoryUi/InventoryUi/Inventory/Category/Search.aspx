...
<table class="table-condensed">
    <tr>
        ...
        <td><asp:Button ID="CmdSearchById" runat="server" Text="🔍" OnClick="CmdSearchById_Click" Font-Names="Arial Unicode MS" /></td>
    </tr>
    <tr>
        <td>Name</td>
        <td><asp:TextBox ID="TxtCategoryName" runat="server" MaxLength="100"></asp:TextBox></td>
        <td><asp:Button ID="CmdSearchByName" runat="server" Text="🔍" OnClick="CmdSearchByName_Click" /></td>
    </tr>
    <tr>
        <td>Description</td>
