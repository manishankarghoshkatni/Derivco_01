...
<table class="table-condensed">
    <tr>
        ...
        <td><asp:TextBox ID="TxtUnitName" runat="server" MaxLength="100"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" ControlToValidate="TxtUnitName" runat="server" ErrorMessage="RequiredFieldValidator">Unit Name is required</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>Description</td>
        <td colspan="2" ><asp:TextBox ID="TxtDescription" runat="server" MaxLength="300"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ForeColor="Red" runat="server" ControlToValidate="TxtDescription" ErrorMessage="RequiredFieldValidator">Unit Description is required</asp:RequiredFieldValidator>
        </td>
    </tr>
</table>
